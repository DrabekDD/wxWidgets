...
//(*IdInit(wxSDialog)
const wxWindowID wxSDialog::ID_STATICTEXT1 = wxNewId();
const wxWindowID wxSDialog::ID_BUTTON1 = wxNewId();
const wxWindowID wxSDialog::ID_STATICLINE1 = wxNewId();
const wxWindowID wxSDialog::ID_BUTTON2 = wxNewId();
//*)

BEGIN_EVENT_TABLE(wxSDialog,wxDialog)
    //(*EventTable(wxSDialog)
    //*)
END_EVENT_TABLE()

wxSDialog::wxSDialog(wxWindow* parent,wxWindowID id)
{
    //(*Initialize(wxSDialog)
    ...
    Connect(ID_BUTTON1, wxEVT_COMMAND_BUTTON_CLICKED, (wxObjectEventFunction)&wxSDialog::OnAbout);
    Connect(ID_BUTTON2, wxEVT_COMMAND_BUTTON_CLICKED, (wxObjectEventFunction)&wxSDialog::OnQuit);
    //*)
}
...
void wxSDialog::OnQuit(wxCommandEvent& event)
{
    Close();
}

void wxSDialog::OnAbout(wxCommandEvent& event)
{
