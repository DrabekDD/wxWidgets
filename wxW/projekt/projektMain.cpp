...
BEGIN_EVENT_TABLE(projektFrame, wxFrame)
    EVT_CLOSE(projektFrame::OnClose)
    EVT_MENU(idMenuQuit, projektFrame::OnQuit)
    EVT_MENU(idMenuAbout, projektFrame::OnAbout)
END_EVENT_TABLE()

projektFrame::projektFrame(wxFrame *frame, const wxString& title)
